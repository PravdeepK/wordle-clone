    ...
    function connect() {
      ...
      ws.onmessage = (event: MessageEvent) => {
        ...
        try {
          ...
          if (type === "room-created")    opts.onRoomJoined?.(payload.roomId, payload.word);
          if (type === "room-joined")     opts.onRoomJoined?.(payload.roomId, payload.word);
          if (type === "guest-joined")    opts.onGuestJoined?.();
